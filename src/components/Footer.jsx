...
export default function Footer() {
  return (
    <footer className="w-full border-t border-border">
      <div className="mx-auto flex max-w-[1440px] flex-col px-6 py-4 md:px-12 lg:px-24">
        ...
        <p className="mt-4 text-[12px] text-ink-soft">Designed by me, coded with Claude Code</p>
      </div>
    </footer>
  )
}
